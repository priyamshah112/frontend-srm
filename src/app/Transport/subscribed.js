...
const useStyle = makeStyles((theme) => ({
	...
	card_action: {
		width: '100%',
		height: '80px',
		background: '#CAC7DF 0% 0% no-repeat padding-box',
	...
	card_action_content: {
		...
		color: '#1C1C1E',
		textAlign: 'center',
		font: 'normal normal normal 14px/14px Avenir',
		letterSpacing: '0px',
		opacity: '1',
	},
	profilePictureDiv: {
	...
	card3_content2: {
		...
		color: '#1C1C1E',
		textAlign: 'left',
		font: 'normal normal 300 14px/20px Avenir',
		letterSpacing: '0px',
		opacity: '1',
	},
}))
								...
								<CardContent className={classes.cardContent}>
									<div className={classes.card_left}>
										<div className={classes.pad}>
											...
											<div>
												<span className={classes.card1_content2_part_1}>
													Start:{' '}
												</span>
												<span className={classes.card1_content2_part_2}>
													{' '}
													Arekere
												</span>
											</div>
									...
									<div className={classes.card_right}>
										<div className={classes.card_action}>
											<div
												className={classes.card_action_content}
												onClick={() => openmaps('modify')}
											>
												<br />
								...
								<CardContent className={classes.cardContent}>
									<div className={classes.card_left}>
										<div className={classes.pad}>
											...
											<div className={classes.card2_content2}>
												Tata motors starbus skool, 26 seater, AC Diesel Bus
											</div>
										</div>
									</div>
									<div className={classes.card_right}>
										<div className={classes.card_action}>
											<div
												className={classes.card_action_content}
												onClick={() => openmaps('track')}
											>
												<br />
												<LocationOnOutlinedIcon
													className={classes.iconStyle_m}
												/>
												<br />
												Track <br />
												Bus
							...
							<Card className={classes.card}>
								<CardContent className={classes.cardContent}>
									<div className={classes.card_left_1}>
										<div className={classes.pad}>
											<div className={classes.card3_content1}>
												Manjunath Kumar 4.8{' '}
												<img src={bus_detail} className={classes.iconStyle_1} />{' '}
											</div>
											<div className={classes.card3_content2}>
												<img src={bus_detail} className={classes.iconStyle_1} />{' '}
												Arekere, Bengaluru 76
											</div>
											<div className={classes.card3_content2}>
												{' '}
												<img
													src={bus_detail}
													className={classes.iconStyle_1}
												/>{' '}
												+91 93837 48273
											</div>
										</div>
