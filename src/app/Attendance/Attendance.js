...
const Attendance = (props) => {
    ...
    const rows = [
        createData('01', 'Samarth Atmakur', 1, 0, 2, 3, 1, 2, 3),
        createData('02', 'Jishnu Karunakar', 1, 0, 2, 3, 1, 1, 0),
        createData('03', 'Prathyusha Atmakur', 1, 0, 2, 3, 1, 1, 0),
        createData('04', 'Leena Mahadevan', 1, 0, 2, 3, 1, 1, 0),
        createData('05', 'Manohar Ramarao', 1, 0, 2, 3, 1, 1, 0),
        createData('06', 'Vishwananath G', 1, 0, 2, 3, 1, 1, 0),
        createData('07', 'Samarth Atmakur', 1, 0, 2, 3, 1, 1, 0),
        createData('08', 'Jishnu Karunakar', 1, 0, 2, 3, 1, 1, 0),
        createData('09', 'Prathyusha Atmakur', 1, 0, 2, 3, 1, 1, 0),
        createData('10', 'Leena Mahadevan', 1, 0, 2, 3, 1, 1, 0),
        createData('11', 'Manohar Ramarao', 1, 0, 2, 3, 1, 1, 0),
        createData('12', 'Vishwananath G', 1, 0, 2, 3, 1, 1, 0),
        createData('13', 'Samarth Atmakur', 1, 0, 2, 3, 1, 1, 0),
        createData('14', 'Jishnu Karunakar', 1, 0, 2, 3, 1, 1, 0),
        createData('15', 'Prathyusha Atmakur', 1, 0, 2, 3, 1, 1, 0),
        createData('16', 'Leena Mahadevan', 1, 0, 2, 3, 1, 1, 0),
        createData('17', 'Manohar Ramarao', 1, 0, 2, 3, 1, 1, 0),
        createData('18', 'Vishwananath G', 1, 0, 2, 3, 1, 1, 0),
        createData('19', 'Samarth Atmakur', 1, 0, 2, 3, 1, 1, 0),
    ];
            ...
            <Grid container className={classes.content}>
                <Grid item sm={12} className={classes.panel}>
                    ...
                    <TableContainer component={Paper}>
                        <div className={classes.tableHeader}><p style={{textAlign: 'center', margin: '5px'}}>Weekly</p></div>
                        <Table aria-label="customized table">
                            ...
                            <TableBody>
                                {rows.map((row) => (
                                    <StyledTableRow key={row.name} className="statusTable">
