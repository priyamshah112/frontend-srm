...
function AssignmentDetails(props) {
  ...
  const fetchAssignmentDetails = (currentPage) => {
    setLoader(true)
    props.getReportById(id, 'assignment', currentPage, onSuccess)
  }
  useEffect(() => {
    fetchAssignmentDetails(1)
  }, [])
    ...
    <>
      <div onScroll={handleLoadMore} className={classes.sectionContainer}>
        ...
        <Card className={classes.card}>
          ...
          <AssignmentTable report={report} loading={loading} />
          {loading ? (
